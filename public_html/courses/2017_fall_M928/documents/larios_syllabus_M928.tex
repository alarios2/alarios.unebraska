...
\hfill
\\
\textbf{Web:} \url{www.math.unl.edu/~alarios2/courses/2017_fall_M928/content.shtml}
%&&
...
%&& 
 ...
 %This course will require basic computer skills.  We will learn programming, but prior knowledge of programming is \textit{not} a prerequisite.
...
%Igor Griva, Stephen G. Nash, and Ariela Sofer.  \textit{Linear and Nonlinear Optimization}, $2^{\text{nd}}$ Edition. Society for Industrial Mathematics (SIAM). ISBN-13: 978-0898716610.
...
% Sept. 4, 2015 (Friday): & Last day to withdraw from this course and not have\\& it appear on your transcript.\\
% Oct. 16, 2015 (Friday): & Last day to change your grade option to or from \\&Pass/No
%     Pass.\\
% Nov. 13, 2015 (Friday): &  Last day to drop this course and receive a grade of \\&W.
...
% Baire, open mapping, closed graph, Hahn–Banach, Alaoglu, Krein–Milman, Stone–Weierstrass theorem
