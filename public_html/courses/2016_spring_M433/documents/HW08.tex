...
\fancyhf{}
\lhead{Math 433/833}
\chead{\textbf{Assignment \# 8}}
\rhead{\textbf{\textbf{Not Collected}}}
% \rfoot{Page \thepage}
...
\begin{enumerate}
% \setcounter{enumi}{0}
\item Read sections 14.4, 14.6, 15.2,  in the book. 

\item Do problem 4.4(i) on page 501.

\item Do problem 4.5 on page 501.


\item Do problem 2.1 on page 555.  Just set it up, and perform one iteration if you want to see how it works.  No need to code the problem and find a final answer.

\item Do problem 2.3 on page 556.

\hspace{-1.5cm}
\textbf{\underline{Challenge problems}: Do these only if you want extra practice.}

\item Do problem 4.8 on page 501. 

\item Do problem 2.8 on page 556.

\item Do problem 2.9 on page 556. 

\end{enumerate}

\noindent
\textbf{Note 1:} This homework will not be collected!  There is no need to write up the problems and turn them in.  These are just some practice problems for the final exam.  

\bigskip


\noindent
\textbf{Note 2:} The challenge problems don't need to be done to do well on the final exam.  Some students asked for extra challenges to get a deeper view of the material, so that is why they are included.  Even if you don't finish the challenge problems, you may want to read them just to think about the material in a new way.
...
% cp ~/m/t/2016_spring_M433/HW/HW08.{pdf,tex} ~/Library/Public_html/courses/2016_spring_M433/documents/  && chmod 755 ~/Library/Public_html/courses/2016_spring_M433/documents/HW08.{pdf,tex}
