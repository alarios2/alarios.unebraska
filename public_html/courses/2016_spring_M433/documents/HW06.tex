...
\rhead{\textbf{Assigned: 2016.03.15}\\\textbf{Due: 2016.03.29}}
% \rfoot{Page \thepage}
...
\begin{enumerate}
% \setcounter{enumi}{0}
 \item Read sections 3.1, 3.2, 14.1, and 14.2 in the book.  (Note: in Assignment \# 5, you were asked to read section 12.3.  Make sure you heave read that before beginning this homework.)
...
\item Page 84-85, \#2.1 (i) and (iii).

\item Page 85, \#2.6.  (Note: This probably is somewhat more open-ended.)
...
% cp ~/m/t/2016_spring_M433/HW/HW06.{pdf,tex} ~/Library/Public_html/courses/2016_spring_M433/documents/  && chmod 755 ~/Library/Public_html/courses/2016_spring_M433/documents/HW06.{pdf,tex}